...
class AsyncSagaxAuditClient:
    ...
    async def download_review_card(self, review_id: str,
                                   dest: Optional[str] = None
                                   ) -> Union[bytes, str]:
        return await self._call("download_review_card", review_id, dest)

    async def download_review_card_pdf(self, review_id: str,
                                       dest: Optional[str] = None
                                       ) -> Union[bytes, str]:
        return await self._call("download_review_card_pdf", review_id, dest)
